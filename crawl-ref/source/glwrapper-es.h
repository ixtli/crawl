#ifndef GLES_GL_WRAPPER_H
#define GLES_GL_WRAPPER_H
...
class GLESStateManager : public GLStateManager
{
public:
    GLESStateManager();
...
class GLESShapeBuffer : public GLShapeBuffer
{
public:
    GLESShapeBuffer(bool texture = false, bool colour = false,
